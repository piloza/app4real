        ...
        children: [
          CustomScrollView(
            slivers: [
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Padding(
                        ...
                        child: CircleAvatar(
                          radius: 32,
                          backgroundImage:
                              AssetImage('assets/${imageNames[index]}'),
                        ),
                      );
                    },
                  ),
              ...
              SliverList(
                //SE MODIFICÓ ESTA LISTA PARA QUE LE PUEDA PASAR ATRIBUTOS A LA CARD DEFINIDA EN ITEMS.DART
                ...
                delegate: SliverChildListDelegate(
                  [
                    llamadasItem(context,
                        'Germán'), //acá conviene crear un nuevo elemento en items.dart
