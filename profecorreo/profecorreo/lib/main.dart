...
//PRIMER SEGMENTO
            ...
            Padding(
              padding: const EdgeInsets.fromLTRB(
                  16, 0, 16, 0), // Margen izquierdo y derecho para el TextField
                    ...
                    child: const Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                              height: 4.0), // Espacio entre las líneas de texto
                          Text(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const DetalleMatch()),
                            );
                          },
                          child: Column(
//PARA TRABAJAR ALGUNA PÁGINA
                            children: [],
                          ),
                        ),
                      ),
...
//ESTO LO USARÉ PARA LA PANTALLA DE OPCIONES
                          },
                          child: const Column(),
                        ),
                      ),
                        ...
                        child: GestureDetector(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const DetalleClubes()),
                            );
                          },
                          child: const Column(
                            children: [],
